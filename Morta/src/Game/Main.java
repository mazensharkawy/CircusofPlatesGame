...
//		GameEngine.start("Very Simple Game in 99 Line of Code", new eg.edu.alexu.csd.oop.game.sample.world.StarWar(800, 600), menuBar, Color.BLACK);
 ...
 /* allow pause, resume, and restart multiple worlds in the same frame */
        ...
        menuBar.add(menu);
        final GameEngine.GameController gameController = GameEngine.start("Very Simple Game in 99 Line of Code", MortaCircus.getInstance(), menuBar, Color.WHITE);
        System.out.println("test1");
        newMenuItem.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                gameController.changeWorld(MortaCircus.getInstance());
            }
        });
